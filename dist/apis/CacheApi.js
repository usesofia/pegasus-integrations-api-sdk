...
var CacheApi = /** @class */ (function (_super) {
     ...
     * Get string value from cache
     */
    CacheApi.prototype.getCacheValue = function (initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getCacheValueRaw(initOverrides)];
                    case 1:
                        response = _a.sent();
     ...
     * Set string value in cache with 10-second TTL
     */
    CacheApi.prototype.setCacheValue = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.setCacheValueRaw(requestParameters, initOverrides)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
