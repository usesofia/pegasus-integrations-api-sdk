...
var AccountsApi = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    case 0:
                        if (requestParameters['itemId'] == null) {
                            throw new runtime.RequiredError('itemId', 'Required parameter "itemId" was null or undefined when calling findAllAccounts().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return jsonValue.map(index_1.RawAccountEntityFromJSON); })];
                }
            });
        });
    };
     ...
     * Find all accounts for a given item
     */
    AccountsApi.prototype.findAllAccounts = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.findAllAccountsRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                ...
                switch (_a.label) {
                    case 0:
                        if (requestParameters['accountId'] == null) {
                            throw new runtime.RequiredError('accountId', 'Required parameter "accountId" was null or undefined when calling getLastAccountSuccessSync().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, index_1.AccountLastSuccessSyncEntityFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Get the last successful sync date for an account
     */
    AccountsApi.prototype.getLastAccountSuccessSync = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getLastAccountSuccessSyncRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
                ...
                switch (_a.label) {
                    case 0:
                        if (requestParameters['onBankAccountCreatedPayload'] == null) {
                            throw new runtime.RequiredError('onBankAccountCreatedPayload', 'Required parameter "onBankAccountCreatedPayload" was null or undefined when calling startAccountTransactionsSync().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: (0, index_1.OnBankAccountCreatedPayloadToJSON)(requestParameters['onBankAccountCreatedPayload']),
                            }, initOverrides)];
                    case 1:
                        response = _a.sent();
     ...
     * Start account transactions sync
     */
    AccountsApi.prototype.startAccountTransactionsSync = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.startAccountTransactionsSyncRaw(requestParameters, initOverrides)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
